...
export class AuthService {
  ...
  autoLogin(){
    ...
    if(!userData){
      ...
      const user = new User(userData.username, userData.id, userData._token , expirationDate,userData.address,userData.afm,userData.city,userData.doy,userData.eponimia,userData.phone1,userData.phone2,userData.zip,userData.trdr,userData.email,userData.emporiki_katigoria,userData.geografikh_zwnh,userData.metaforeas,userData.dromologio,userData.metaforiko_meso,userData.tropos_apostolis);
      this.user.next(user);
      // this.autoLogout(expiresIn * 1000);
      localStorage.setItem('userData', JSON.stringify(user));
    }

    const loadedUser = new User(userData.username,userData.id,userData._token, new Date(userData._tokenExpirationDate),userData.address,userData.afm,userData.city,userData.doy,userData.eponimia,userData.phone1,userData.phone2,userData.zip,userData.trdr,userData.email,userData.emporiki_katigoria,userData.geografikh_zwnh,userData.metaforeas,userData.dromologio,userData.metaforiko_meso,userData.tropos_apostolis);
