...
export class ProductPageComponent implements OnInit {
  ...
  async uploadDescription() {
    ...
    if (
      ...
      setTimeout(() => {
        this.product.description = req.data.description;
        this.product.description_eng = req.data.desc_eng;
  ...
  async updateDataSheet() {
    if (this.dataSheetForm.value.datas == null || this.dataSheetFormEng.value.datasEng == null){
      this.emptyText = true;
    }else{
     ...
     let req = await axios
      .post(
        'https://perlarest.vinoitalia.gr/php-auth-api/updateDataSheet.php',
        {
          ...
          setTimeout(() => {
            console.log(req.data);
            this.product.data_sheet_eng = req.data.data_sheet_eng
            this.product.data_sheet = req.data.data_sheet;
            console.log(this.product);
